...
in Figure~\ref{fig:GaussianBeamDiffraction:Kirchhoff_geometry}(a).
...
in Figure~\ref{fig:GaussianBeamDiffraction:Kirchhoff_geometry}(b).
That is, $S = S_1 + S_2$,
...
Figure~{\ref{fig:GaussianBeamDiffraction:Fraunhofer_geometric_phase_factor}}.
Substituting
...
in Figure~\ref{fig:GaussianBeamDiffraction:coordinate_rotation}.
...
such that the beam's diffraction is well within the Raman-Nath regime.
