...
Previous sound-wave calibrations were performed
with high-frequency speakers
suitable for characterizing the medium-$k$ to high-$k$
response of the PCI.
However, to quantify the low-$k$ to medium-$k$ response
of the heterodyne interferometer
(and simultaneously cross-calibrate the PCI),
...
The bounds on the variance of the phase shift imparted
...
\begin{figure}
  ...
  \caption[Variance of phase shift imparted to a CO$_2$ probe beam]{%
    The bounds on the variance of the phase shift
