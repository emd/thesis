...
\newcommand{\gammahighk}{\gamma_{\text{high-k}}}
\newcommand{\gammalowk}{\gamma_{\text{low-k}}}
...
% \includeonly{FrontBackmatter/Cover}%
...
% \includeonly{Chapters/Conclusions/Conclusions}
...
\include{Chapters/InterferometricMethods/InterferometricMethods}%
\include{Chapters/DesignConsiderations/DesignConsiderations}%
\include{Chapters/Implementation/Implementation}%
\include{Chapters/TurbulenceMeasurements/TurbulenceMeasurements}%
\include{Chapters/ToroidalCorrelation/ToroidalCorrelation}%
...
\appendix%
\cleardoublepage%
\include{Appendices/GaussianBeamDiffraction/GaussianBeamDiffraction}%
\include{Appendices/ImagingSystems/ImagingSystems}%
\include{Appendices/PCIResponseIdentities/PCIResponseIdentities}%
\include{Appendices/OscillatorPhaseNoise/OscillatorPhaseNoise}%
\include{Appendices/SoundWaveCharacterization/SoundWaveCharacterization}%
\include{Appendices/SpectralEstimation/SpectralEstimation}%
\include{Appendices/DigitizerSynchronization/DigitizerSynchronization}%
% \include{Appendices/ExternalClock/ExternalClock}%
% \include{biblio}
