...
\newcommand{\myVersion}{version 7.5\xspace}
\usepackage{stmaryrd}
...
\def\@copyrightnotice{\copyright\ \@degreeyear~\Mit.  All rights reserved.}
...
\areaset[current]{340pt}{690pt} % 686 (factor 2.2) + 33 head + 42 head \the\footskip
