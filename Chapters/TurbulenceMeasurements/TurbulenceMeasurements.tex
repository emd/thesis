...
Now, the PCI-measured angular frequency is
...
\end{align}
Using $\vExB$ from (\ref{eq:TurbulenceMeasurements:vExB}) and
...
\end{equation}
Note that the first term corresponds to
the major-radial projection of the $ExB$ velocity and
that the second term corresponds to
the major radial projection of the plasma-frame phase velocity.
