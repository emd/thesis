...
\begin{figure}
  ...
  \caption[Time histories of various actuators \& plasma parameters]{%
    ...
    (a) neutral beam injected (NBI) power $P_{\text{inj}}$,
    (b) NBI torque $T_{\text{inj}}$,
    (c) electron cyclotron resonance heating (ECH) power $P_{\text{ECH}}$,
    (d) ECH location $\rho_{\text{ECH}}$,
