...
\begin{itemize}
  ...
  \item Section~\ref{sec:TurbulenceMeasurements:Modeling:linear_stability_overview}
    discusses \ldots
  \item Section~\ref{sec:TurbulenceMeasurements:Modeling:predicted_phase_velocity}
    attempts \ldots
...
\subsection{Relation of field-aligned \& PCI-measured wavevectors}
...
\label{fig:TurbulenceMeasurements:predicted_pci_phase_velocities.pdf}
\end{figure}
