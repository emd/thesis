...
Following the formalism pioneered by Raman and Nath
...
for a CO$_2$ probe beam ($k_0 \approx 2 \pi \cdot \SI{e5}{\per\centi\meter}$)
...
\subsection{On the scalar nature of the diffraction theory}
