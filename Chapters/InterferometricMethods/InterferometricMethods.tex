...
It will be convenient to know the transformation
from the native coordinate system of the $m$\ts{th} scattered beam
to that of the unscattered beam in the image plane,
which is hereafter referred to as the lab-frame coordinate system.
See Fig\ldots for the relevant geometry\ldots
