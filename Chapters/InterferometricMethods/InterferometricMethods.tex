...
$\{\phi_R - \bar{\phi}, \tilde{\phi}_0, I_G(\vect{r}_{\image})\}$, but
...
$\{\bar{\phi}, \tilde{\phi}_0, I_G(\vect{r}_{\image})\}$;
...
Because $\tilde{\phi}_0 \ll 1$, the heterodyne intensity
...
\graffito{\textcolor{red}{Add comment about generalizing to broadband}}
\begin{align}
