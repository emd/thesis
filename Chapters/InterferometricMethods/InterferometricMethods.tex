...
more sensitive than a homodyne interferometer
($\phi_R - \bar{\phi} = \pi / 2$) and
$T_{\text{pci}} / T_{\text{het}} = 8 / \sqrt{\eta}$
more sensitive than a heterodyne interferometer.
...
Costs of sensitivity:
\begin{itemize}
  \item Inability to measure equilibrium
    \begin{itemize}
      \item Physical description of why for PCI
      \item Also in optimal homodyne configuration
    \end{itemize}
  \item Sensitivity to alignment
    \begin{itemize}
      \item PCI phase-plate groove
      \item Homodyne interferometer $\phi_R - \bar{\phi} = \pi / 2$
      \item Such feedback stabilization is expected to become
        more commonplace in the future\ldots
    \end{itemize}
  \item Inability to measure absolute fluctuation scale
\end{itemize}
