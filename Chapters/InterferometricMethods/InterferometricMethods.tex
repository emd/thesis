...
the phase groove typically reflects only a fraction $\rho < 1$
...
for $k \geq k_{\text{min}}$ where
\begin{equation}
  k_{\text{min}} \equiv \frac{k_0 d}{2 |F|}
...
($2 w_0' \leq d$), which usually has a reflectivity $\rho \ll 1$.
...
That is, PCI's minimum detectable wavenumber
