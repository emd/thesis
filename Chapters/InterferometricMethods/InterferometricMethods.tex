...
\subsection{Fluctuation sensitivity}
\begin{itemize}
  \item Beam-center transfer function for homodyne, heterodyne, and PCI
    on a y-log plot
    \begin{itemize}
      \item Wavenumber hole in PCI
      \item Amplitude differences
      \item Absolute calibration
    \end{itemize}
  \item PCI drawbacks
    \begin{itemize}
      \item Vibration feedback system (but needed on ITER interferometer)
      \item No equilibrium
    \end{itemize}
\end{itemize}


\subsection{Low-$k$, nonlinear upshift in PCI-measured wavenumber}


\subsection{A note on finite-diameter collection optics}
\begin{itemize}
  \item  via finite $k_D$ cutoff in PCI
\end{itemize}


\subsection{Temporal bandwidth considerations}
