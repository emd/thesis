...
\begin{align}
  ...
  \notag \\
  &=
  \frac{c \varepsilon_0 |E_{G'}(\vect{r'}, t)|^2}{2}
...
\begin{equation}
  E_R(\vect{r}, t) = [E_G(\vect{r}, t)] A e^{i \phi_R}
  \label{eq:InterferometricMethods:external_reference_beam_arbitrary}
\end{equation}
Here, $A$ and $\phi_R$ are real quantities.
...
where
\graffito{\textcolor{red}{%
  Wait. Is factor of 2 attributable to averaging over optical cycles?}}
\begin{equation}
  I_G(\vect{r}, t)
  \equiv
  \frac{c \varepsilon_0 |E_G(\vect{r}, t)|^2}{2}
\end{equation}
