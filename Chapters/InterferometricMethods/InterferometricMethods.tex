...
% Two of the limiting cases for $q'$ take on physical significance
% when the waist of the probe beam sits at the object plane
% (i.e.\ $q = i z_R$ and $z = 0$).
% If $C q \ll 1 / M$,
% then $q' \approx M^2 q = i M^2 z_R$, and
% $z' = \text{Re}(q') \approx 0$;
% that is, the waists of the imaged beams sit at the image plane.
% If, however, $C q \gg 1 / M$,
% then $q' \approx M / C$, and
% $z' = \text{Re}(q') = M / C \neq 0$;
% that is, the waists of the imaged beams do \emph{not} sit at the image plane.
...
\subsection{Imaging of diffracted beams}
...
\begin{equation}
  \begin{aligned}
    ...
    \biggl[%
      ...
      \cos\left( \frac{k x}{M} - \omega t \right)
    \biggl]
  \end{aligned}
