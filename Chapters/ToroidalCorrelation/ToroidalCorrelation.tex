...
\begin{itemize}
  \item Basic idea
  \item \ldots but what to do in the presence of noise?
\end{itemize}
...
\end{equation}
\textcolor{red}{Criterion for $G_{xx}(f) \gg |G_{xn}(f)|$.}
...
(\ref{eq:ToroidalCorrelation:wavenumber_estimate}).
...
\begin{equation}
  ...
  \qquad \text{for unknown propagation direction}
  \label{eq:ToroidalCorrelation:Nyquist_criterion_unknown_prop_direction}
\end{equation}
Note that
(\ref{eq:ToroidalCorrelation:Nyquist_criterion_unknown_prop_direction})
