...
\begin{itemize}
  \item Brief discussion of broadband turbulence and dominant instabilities
    \begin{itemize}
      \item Discussion of N. Howard's multiscale work
        \cite{howard_pp14,howard_nf16}
        and the need to validate against experiment
    \end{itemize}
  \item Very brief discussion of fast-ion transport due to
    Alfv\'{e}n eigenmodes
\end{itemize}
