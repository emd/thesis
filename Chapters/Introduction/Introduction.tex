...
to replicate this process controllably in the laboratory
for a source of safe, clean, and virtually inexhaustible energy.
The core principle is simple:
combine (i.e. ``fuse'') the nuclei of multiple light elements
...
\begin{itemize}
  \item Cross section
  \item Ignition criterion
  \item Plasma requires novel confinement and means of diagnosing
\end{itemize}
