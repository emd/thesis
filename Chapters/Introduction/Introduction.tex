...
uniform, bulk contribution $\phi_0$ and
...
\begin{equation}
  ...
  2 E_0^2 \left\{
    ...
    +
    \left[
      \cos \left(\Delta \omega_0 t + \phi_0 \right)
      -
      \tilde{\phi} \sin \left( \Delta \omega_0 t + \phi_0 \right)
    \right]
  \right\}.
\end{equation}
As $\tilde{\phi} \ll 1$,
...
\begin{equation}
  E_0 e^{i \phi}
  =
  E_0 e^{i \left( \phi_0 + \tilde{\phi} \right)}
  \approx
  E_0 e^{i \phi_0} \left( 1 + i \tilde{\phi} \right),
\end{equation}
...
\begin{equation}
  E_R = -E_0 e^{i \phi_0} \left( 1 - i \sqrt{\eta} \right)
\end{equation}
...
\begin{equation}
  ...
  E_R + E_0 e^{i \phi}
  \approx
  i E_0 e^{i \phi_0} \left( \sqrt{\eta} + \tilde{\phi} \right),
\end{equation}
with corresponding intensity (averaged over an optical cycle)
\begin{equation}
  I_{\text{PCI}}
...
Note, however, that information about the bulk phase $\phi_0$ is lost.
...
to the component of the field corresponding to the bulk phase $\phi_0$.
