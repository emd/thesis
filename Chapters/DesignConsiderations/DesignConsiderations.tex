...
Thus, in the context of of the AOM's finite coupling time and
the local oscillator's jitter, the heterodyne intensity
(\ref{eq:InterferometricMethods:heterodyne_intensity})
generalizes to
\begin{equation}
  \begin{aligned}
    ...
    \bigr\},
  \end{aligned}
  \label{eq:DesignConsiderations:heterodyne_intensity_finite_AOM_coupling_time}
\end{equation}
