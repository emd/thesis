...
The mean square error (i.e.\ variance) is simply
\begin{equation}
...
\section{Nonideal demodulation}
\graffito{\textcolor{red}{reference earlier use of inverse tangent}}
Quadrature heterodyne detection yields
the in-phase ($I$) and quadrature ($Q$) signals.
Ideally, $I = I_0 \cos\phi$ and $Q = Q_0 \sin\phi$ with $I_0 = Q_0$
such that the absolute phase can be extracted as $\phi = \atan(Q / I)$.
However,
\begin{itemize}
  \item discussion here: \texttt{\path{/Users/emd/Google Drive/meeting_notes/1160523_porkolab/presentation}}
  \item Implications for phase computation
\end{itemize}

\subsection{Demodulator imperfections}
\begin{itemize}
