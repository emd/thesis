...
a peak-to-peak input-voltage range $V_{\text{in}}$,
then its quantum of voltage $\Delta V$ is
\begin{equation}
  \Delta V
  =
  \frac{V_{\text{in}}}{2^{N_b} - 1}
  \approx
  \frac{V_{\text{in}}}{2^{N_b}},
...
of the digitizer's input-voltage range; that is,
...
to utilize the full input-voltage range of the digitizer.
...
the digitizer's full input-voltage range $V_{\text{in}}$ such that
the squared radius of the Lissajous curve is
$I^2 + Q^2 = (\eta_{\text{dyn}} V_{\text{in}} / 2)^2$, and
...
\begin{itemize}
  ...
  \item \emph{Quantization noise} is produced
    ...
    of the digitizers's peak-to-peak input-voltage range $V_{\text{in}}$
    occupied by the $I$ and $Q$ signals, i.e.\
    \begin{equation}
      \eta_{\text{dyn}}
      =
      \frac{\text{max}(I) - \text{min}(I)}{V_{\text{in}}}
      =
      \frac{\text{max}(Q) - \text{min}(Q)}{V_{\text{in}}}.
