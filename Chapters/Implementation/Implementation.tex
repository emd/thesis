...
\begin{itemize}
  \item Half-waveplate for polarization rotation
  \item No lenses -- corresponding curvature criterion
  \item Beam combiner with polarization-independent splitter
\end{itemize}
...
\subsection{Sensitivity to component placement}
\begin{itemize}
  \item Need to split beam before phase plate
