...
The section builds on Coda's discussion to examine
the effect of the feedback system on the misalignment angle $\theta$
between the unscattered probe beam and the nominal optical axis
at the image plane.
It is then shown that, for certain imaging systems,
the pre-existing PCI feedback system can also be used
to satisfy the heterodyne interferometer's coalignment constraint
