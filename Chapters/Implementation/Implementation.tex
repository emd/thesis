...
\begin{equation}
  ...
  \sqrt{%
    \frac{%
      ...
      \text{var} \left[ \tilde{y}_{\text{pci}}(k) \right]
    }
  }
  =
...
\begin{figure}
  ...
  \caption[Cross-calibration of PCI]{%
    ...
    The strong response of the \emph{combined} system
    across the surveyed wavenumber range
    demonstrates the complementary nature
    of the interferometer and PCI measurements and
    confirms the ability to simultaneously monitor
    low-$k$ and high-$k$ instabilities.
