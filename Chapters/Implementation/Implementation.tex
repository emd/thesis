...
OCXO
\begin{itemize}
  \item Wenzel Associates, Inc. (Austin, TX USA)
  \item Sprinter packaging
  \item $f_0 = \SI{30}{\mega\hertz}$
  \item 13 dBm output into $\SI{50}{\ohm}$
  \item Phase noise $\mathcal{L}(f) = -165 \; \text{dBc}$
    for $f \geq \SI{10}{\kilo\hertz}$
\end{itemize}

Rack-mounted module
\begin{itemize}
  \item Look in 1170405\_OCXO meeting notes
  \item Picture?
\end{itemize}


\subsection{High-power RF amplifier}
\subsection{Detector}
\begin{itemize}
