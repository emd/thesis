...
\subsection{Gaussian-beam power \& peak intensity}
...
\end{equation}
where $I(0, z) = (c \varepsilon_0 / 2) [E_0 w_0 / w(z)]^2$
is the peak, on-axis intensity of the Gaussian beam
at axial distance $z$ from the beam waist.
Note that $I(0, z) = [w_0 / w(z)]^2 \cdot I(0, 0)$.
The total optical power $\mathcal{P}$ in the beam is
\begin{equation}
  \mathcal{P}
  =
  \int_{\mathbb{R}^2} I(\rho, z) dA
  =
  \frac{\pi w_0^2}{2} \cdot I(0, 0).
\end{equation}
Thus, at any axial distance $z$ from the beam waist,
the peak, on-axis intensity of the Gaussian beam becomes
\begin{equation}
  I(0, z) = \frac{2 \mathcal{P}}{\pi [w(z)]^2}.
\end{equation}
...
$\mathcal{P}_{\text{pci}} / \mathcal{P}_{\text{pci},0} \geq 2 / 3$
is enforced.
...
\begin{equation}
  \mathcal{P}_{\text{pci}}
  +
  \left( \frac{2}{0.17} \right) \mathcal{P}_P
  =
  \mathcal{P}_{\text{pci},0}.
\end{equation}
...
\end{equation}
where $\mathcal{P}_S$ is the total beam power at the laser source.
