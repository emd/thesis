...
\begin{itemize}
  ...
  \item Amplifiers needed to counteract attenuation in delay line,
    but do not appreciably increase noise
  \item $I$ and $Q$ \emph{not} fitted to an ellipse, as
    they are confined to a small point on Lissajous curve
  \item Delay lines discussed previously
  \item Examples of varying delay line in
    Fig.~\ref{fig:Implementation:GnH_self_demodulation};
    note that $\tau = 0$ case is limited by quantization noise and
    that this is for the unstable LO
