...
\begin{itemize}
  \item $\SI{1}{\micro\farad}$ bypass capacitors on op-amp power-supply rails
    to avoid instability~\cite[Sec.~4.2.7]{horowitz_and_hill}
  \item Input bias current -- causes a voltage drop across the resistors
    in a feedback network~\cite[Sec.~4.4.1.C]{horowitz_and_hill}
\end{itemize}
...
\begin{itemize}
  \item Slew rate
  \item GBw product
  \item BJT, requiring balanced input impedances
\end{itemize}
