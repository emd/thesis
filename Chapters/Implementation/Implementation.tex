...
The derivations in Section~\ref{sec:InterferometricMethods:interferometry}
...
\begin{equation}
  ...
  \right],
\end{equation}
and let the image-plane reference beam be given by
\begin{equation}
  E_R(\vect{r}_{R}, t)
  =
...
\subsection{Phase effects of umatched beams}
