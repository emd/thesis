...
\end{equation}
Fig.~\ref{fig:Implementation:interferometer_measured_vs_expected.pdf}
...
\label{fig:Implementation:interferometer_measured_vs_expected.pdf}
\end{figure}
...
%   \centering
%   \includegraphics[width = \textwidth]{%
%     Chapters/Implementation/figs/cross_calibration_spectrograms.pdf}
%   \caption[Sound-wave calibration of combined PCI-interferometer]{%
%     Sound-wave calibration of combined PCI-interferometer.
%     The diagnostic test shot is indicated by
%     the $4$ digit number in the bottom-right corner.
%   }
% \label{fig:cross_calibration_spectrograms}
% \end{figure}
