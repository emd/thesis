...
The robust response of the combined PCI-interferometer
...
A schematic of the combined-PCI interferometer optical table
is shown in Figure~\ref{fig:Implementation:table_layout}.
The interferometer and PCI
...
\begin{figure}[t!]
  ...
  \caption[Sensitivity of optical design to placement of imaging optics]{%
    ...
    The distance between the focusing off-axis parabolic mirror $P2$ and
...
Suitably distributing the optical power in the combined PCI and
...
Figure~\ref{fig:Implementation:power_distribution} shows,
the constraint
$\mathcal{P}_{\text{pci}}
\gtrsim
...
\begin{figure}
  ...
  \caption[Schematic for OCXO rack-mounted module]{%
    Schematic for OCXO rack-mounted module.}
...
Noise predictions establish a baseline for
...
the detector-element area $A = s_x^2 = \SI{1}{\milli\meter\squared}$ and
...
While the noise predictions establish a baseline,
...
to perform vibration subtraction~\cite{carlstrom_rsi88}, or
...
\subsection{Verification of heterodyne-interferometer response}
...
\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{%
    Chapters/Implementation/figs/interferometer_measured_vs_expected.pdf}
...
The response of the heterodyne interferometer to the sound waves
...
\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{%
    Chapters/Implementation/figs/cross_calibration.pdf}
...
As the current heterodyne-interferometer implementation
...
% \begin{itemize}
%   \item \textcolor{red}{Picture}
%   \item \textcolor{red}{Figure of new vs.\ old laser stability}
% \end{itemize}
%
%
...
% As indicated in Figure~\ref{fig:Implementation:d3d_port_locations}(b),
...
% Figure~\ref{fig:Implementation:in_vessel_mirrors}.
